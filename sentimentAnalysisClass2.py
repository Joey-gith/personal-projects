...
print("cn_model.index2word[120]:", cn_model.index_to_key[120])
...
model.add(Bidirectional(LSTM(units=64, return_sequences=True))) #LSTM参数中的return_sequences=True表示每个时间步都输出
